...
- 선택한 해시태그가 없을 경우 랜덤으로 제공됩니다.
  ...
  | 인기페이지                                                                                                      |
  | --------------------------------------------------------------------------------------------------------------- |
  | <img width="300px" src="https://github.com/user-attachments/assets/2a259075-66d9-4359-b4ec-9ea7f7616c66"></img> |
...
- 모든 정보를 입력한 후 ‘플레이리스트 생성’ 버튼을 클릭하면 영상이 등록됩니다.
  ...
  | 플레이리스트 생성                                                                                               |
  | --------------------------------------------------------------------------------------------------------------- |
  | <img width="300px" src="https://github.com/user-attachments/assets/c7302e0f-6d82-4901-8506-23cdfb948d58"></img> |
